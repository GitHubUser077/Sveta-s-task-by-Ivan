...
let testUsers: [SimpleUser] = [
    ...
    SimpleUser(name: "Aaron", avatarImage: "user4", photos: [SimplePhoto(name: "dog1"),SimplePhoto(name: "dog2"),SimplePhoto(name: "dog3"),SimplePhoto(name: "dog4"),SimplePhoto(name: "dog5"),SimplePhoto(name: "dog6"),SimplePhoto(name: "dog7")]),
    ...
    SimpleUser(name: "Daniel", avatarImage: "user11", photos: [SimplePhoto(name: "bird1")]),
